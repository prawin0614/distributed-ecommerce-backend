...
public class OrderConfirmedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4338171780501024948L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderConfirmedEvent\",\"namespace\":\"com.ecommerce.events.avro\",\"fields\":[{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public OrderConfirmedEvent(java.lang.String orderId, java.lang.String status, java.lang.String message) {
   ...
   */
  public static com.ecommerce.events.avro.OrderConfirmedEvent.Builder newBuilder() {
    return new com.ecommerce.events.avro.OrderConfirmedEvent.Builder();
  }
   ...
   * @return A new OrderConfirmedEvent RecordBuilder
   */
  public static com.ecommerce.events.avro.OrderConfirmedEvent.Builder newBuilder(com.ecommerce.events.avro.OrderConfirmedEvent.Builder other) {
    if (other == null) {
      return new com.ecommerce.events.avro.OrderConfirmedEvent.Builder();
    } else {
      return new com.ecommerce.events.avro.OrderConfirmedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderConfirmedEvent RecordBuilder
   */
  public static com.ecommerce.events.avro.OrderConfirmedEvent.Builder newBuilder(com.ecommerce.events.avro.OrderConfirmedEvent other) {
    if (other == null) {
      return new com.ecommerce.events.avro.OrderConfirmedEvent.Builder();
    } else {
      return new com.ecommerce.events.avro.OrderConfirmedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderConfirmedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ecommerce.events.avro.OrderConfirmedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ecommerce.events.avro.OrderConfirmedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.avro.OrderConfirmedEvent.Builder clearMessage() {
      message = null;
